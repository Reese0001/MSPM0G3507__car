...
//MPU6050的AD0为IIC地址引脚，接地时IIC地址为0x68，接VCC时IIC地址为0x69
...
#define MPU6050_RA_SMPLRT_DIV       0x19        //陀螺仪采样率地址  Gyro sampling rate address
#define MPU6050_RA_CONFIG           0x1A        //设置数字低通滤波器地址 Set digital low-pass filter address
