...
#define MPU6050_ANGLE_RESET (0.0f)
#define MPU6050_KALMAN_Q_ANGLE (0.02f)
#define MPU6050_KALMAN_Q_BIAS (0.003f)
#define MPU6050_KALMAN_R_ZERO_RATE (0.5f)
#define MPU6050_KALMAN_MAX_DT_MS (50U)
